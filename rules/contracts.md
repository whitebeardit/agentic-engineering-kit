...
- Ordem: depende de quem introduz a mudança. **Acrescentar** (campo opcional, endpoint, versão nova): contrato → produtor →
  consumidor. **Retirar** o que foi deprecado: consumidores migram → produtor remove — o prazo da deprecação é o contrato.
  **Exigir campo novo no request**: produtor aceita com e sem → consumidores passam a enviar → produtor exige (expand/contract).
