...
2. Liste **consumidores** de cada endpoint/evento alterado: grep no workspace por rota/nome do evento; catálogo de eventos se existir; mapa transversal, se vier no pedido (você não lê o vault).
