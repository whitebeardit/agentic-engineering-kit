...
- Nomes no plugin: `/kit:card-intake`, `/kit:run-and-test`, `/kit:regras-de-negocio`; agentes `kit:impact-analyzer`, `kit:legacy-navigator`, `kit:test-designer`, `kit:dotnet-reviewer`, `kit:contract-reviewer`; spec-driven `/tlc:tlc-spec-driven`.
