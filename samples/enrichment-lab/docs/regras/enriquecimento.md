...
Pendente — card `docs/cards/ENR-042.md`, feature `.specs/features/001-merge-por-unidade/`. Hoje o worker **substitui** o
cadastro pelo evento (`Cliente.substituir`), comportamento provisório sem regra.
