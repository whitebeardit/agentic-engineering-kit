...
| -------- | --------- | ----------- | ------- |
| A | `src/domain/cliente/specifications/evento-elegivel-para-merge.ts:19` | Limiar invertido: `trazidas < limiarN` → `trazidas > limiarN` | ✅ Killed — 2 testes falharam: `RN_ENR_004_IF_cadastro_completo_e_evento_incompleto_THEN_SHALL_recusar` (`TU:12`) e `RN_ENR_004_IF_cadastro_completo_e_evento_incompleto_THEN_aplicar_SHALL_lancar_ruleId` (`TU:137`) |
